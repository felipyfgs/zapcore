...
func (r *MediaRepository) Create(ctx context.Context, mediaFile *domain.MediaFile) error {
	// Define timestamps
	now := time.Now()
	mediaFile.CreatedAt = now
	mediaFile.ExpiresAt = now.Add(domain.DefaultMediaTTL)
...
func (r *MediaRepository) List(ctx context.Context, limit, offset int, messageType, sessionID, sessionName string) ([]domain.MediaFile, int, error) {
...
func (r *MediaRepository) GetExpiredFiles(ctx context.Context) ([]domain.MediaFile, error) {
	var expiredFiles []domain.MediaFile
...
func (r *MediaRepository) GetByMessageType(ctx context.Context, messageType string, limit int) ([]domain.MediaFile, error) {
	var mediaFiles []domain.MediaFile
